...
form.addEventListener('submit', async (e) => {
    ...
    const res = await axios.post('https://effective-succotash-rjrj779r79r2p5w9-3000.app.github.dev/todo/create', { task }); //ye axios se post request bhej raha hai
...
async function getAllTodos() {
    let res = await axios.get("https://effective-succotash-rjrj779r79r2p5w9-3000.app.github.dev/todo/all");
...
todoContainer.addEventListener('click', async (e) => {
    ...
    if (btnClass == "delete") {
        await axios.delete(`https://effective-succotash-rjrj779r79r2p5w9-3000.app.github.dev/todo/delete/${todoId}`);
    } 
    if (btnClass == "status") {
        await axios.put(`https://effective-succotash-rjrj779r79r2p5w9-3000.app.github.dev/todo/update/${todoId}`)
    }
    getAllTodos();
});
